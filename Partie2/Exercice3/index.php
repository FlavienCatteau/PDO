        ...
        <main>
            <div class="text-center">
                    <?php
                      ...
                      $twentyCustomers = $bdd->query('SELECT lastName,firstName FROM clients LIMIT 20'); // On appelle le nom et le prénom des clients, on limite à 20 (donc les noms des 20 premiers clients)
                      while ($data = $twentyCustomers->fetch())
                      {
                    ?>
